...
<html>
    ...
    <head>
        ...
        <meta name="description" content="Check out the press talk of Sister Technologies.">
    ...
    <body onresize=resizeHandler() itemscope itemtype="http://schema.org/Organization">
        ...
        <div class="prodFeature pressFeat dark clearfix">
            <h3 class="whiteText" itemprop="isRelatedTo">THE PRESS</h3>
            <p class="grayText intro">Sometimes we have the priveledge of being mentioned throughout the great world wide web. Here you can find some articles speaking about our innovation.</p>
        </div>

        <div class="whiteArrow clearfix pressLi">
            <a href="http://www.web55.info/148-automotive-advertising-agencies-focus-on-consumers-vs-auto-dealers-to-sell-cars-because-google-does.html" target="_blank">
                <h3>WEB 55</h3>
                <p class="darkText">Check out how Web55 talks about our SEO capabilities.</p>
            </a>
            <a href="http://www.contactatonce.com/sister-interactive-dealer-video-chat/" target="_blank">
                <h3>CONTACT AT ONCE</h3>
                <p class="darkText">Contact At Once is happy to promote our Video Carlot.</p>
            </a>
            <a href="http://mkgandhi.info/?s=sister+technologies&submit=Search" target="_blank">
                <h3>MK GANDHI</h3>
                <p class="darkText">Mk takes some time to talk about our SEO services through our Video Carlot.</p>
            </a>
            <a href="http://www.nh3.org/60-automotive-advertising-agencies-must-use-yesterdays-knowledge-tomorrows-technology-to-survive.html" target="_blank">
                <h3>NH3</h3>
                <p class="darkText">NH3 talks about our patented TruVoice technology and production process.</p>
            </a>
            <a href="http://www.oakleysunglass.asia/81-automotive-advertising-agencies-prefer-marketing-platforms-vs-individual-vendor-applications.html" target="_blank">
                <h3>BLOG</h3>
                <p class="darkText">Blogger &#8220;OakleySunglass&#8221; speaks about the innovation of Sister Technologies and breadth of the company.</p>
            </a>
        </div>
