...
<html>
    ...
    <head>
        ...
        <meta name="description" content="View Sister Technologies full production carousel and studio product: spinIT.">
        ...
        <script type="text/javascript" src="http://easy360.sister.tv/app/js/SiSTeR360viewer.js"></script>
    ...
    <body onresize=resizeHandler() itemscope itemtype="http://schema.org/Organization">
        ...
        <div class="mLayer">
            <div class="SiSTeR360viewer" data-dealerid="sonic:sw" data-vin="1G1PE5SB4D7230898">Loading player...</div>
        </div>

        <div class="prodInfo" itemscope itemtype="http://schema.org/Product">
            <h3 class="grayText" itemprop="model">SPIN IT</h3>
            <p class="darkText" itemprop="description">Welcome to the future of video production in the automotive industry. SpinIT encompases a photography studio which houses a world class vehicle carousel, studio lighting, cameras, and software to complete an all-in-one production package. By this you achieve video, photography, and interior 360 panoramic shots within minutes and uploaded live to your website and social media via our Media Player instantly.</p>
        ...
        <div class="feature col-1-3" id="carousel">
            <h3 class="grayText" itemprop="isRelatedTo">TOP QUALITY CAROUSEL</h3>
            <p class="whiteText">We teamed up with the top carousel manufacturer in the world (carousel USA) to bring you the most innovative product. With each purchase, you gain access to a custom carousel to fit the needs of your dealership studio.</p>
        </div>

        <div class="feature col-1-3" id="equip">
            <h3 class="grayText" itemprop="isRelatedTo">FULLY INTEGRATED EQUIPMENT</h3>
            <p class="whiteText">Capture interior or exterior shots of your inventory with ease and without hassle. Our new technology allows you to control your atmosphere,  
                capture photogaphs and post them to your website within a matter of minutes. Increase your ROI and get max profit now.</p>
        </div>

        <div class="feature col-1-3" id="invest">
            <h3 class="grayText" itemprop="isRelatedTo">NO CAPITAL INVESTMENT</h3>
            <p class="whiteText">Capture interior or exterior shots of your inventory with ease and without hassle. Our new technology allows you to control your atmosphere,  
                capture photogaphs and post them to your website within a matter of minutes. Increase your ROI and get max profit now.</p>
        </div>
