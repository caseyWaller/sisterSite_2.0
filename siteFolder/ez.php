...
<html>
    ...
    <head>
        ...
        <meta name="description" content="Take interior shots of your inventory with Sister Technologies hassle free product: ez360.">
    ...
    <body onresize=resizeHandler() itemscope itemtype="http://schema.org/Organization">
        ...
        <div class="mLayer">
            <iframe src="http://s3.amazonaws.com/sistertech-krpano-content/testContent/testContentOnS3.html" class="ez"></iframe>
        </div>

        <div class="prodInfo" itemscope itemtype="http://schema.org/Product">
            <h3 class="grayText" itemprop="model">EZ 360</h3>
            <p class="darkText" itemprop="description">The industry's first 360º interior virtual tour which takes just seconds to produce and put buyers in the drivers seat. With the combined technology of our PixZero app that captures, uploads, and publishes pictures instantly to our Media Layer - which displays pcitures, interior 360º, and video in real time across all sites, browsers, PC's, and devices.</p>
        ...
        <div class="feature full" id="zero">
            <h3 class="grayText" itemprop="isRelatedTo">ZERO TIME, ZERO EFFORT, ZERO MISTAKES!</h3>
            <p class="whiteText">Our PixZero app guides the user through the process and uploads the content automatically and instantly. Pictures and 360º interior virtual tour are displayed through the media layer within seconds of capture. The content is stored and displayed from a single location in the cloud - no more data feeds and CSV processing.
            </p>
        </div>
